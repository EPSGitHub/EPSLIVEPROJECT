             ...
             <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active"><a style="color:rgb(100, 201, 231)" href="{{ route('home') }}">Dashboard</a> / <a style="color:rgb(100, 201, 231)" href="{{ route('careers.index') }}">Career post</a> / Department</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="card col-md-12">
                ...
                <div class="card-header">
                    <h4 class="card-title d-inline"> Department</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- </a> --}}
                                        <a href="#" edit_id="{{ $data->id }}" data-toggle="modal" class="btn btn-sm btn-warning update_cat" data-toggle="tooltip modal" title="Edit"><i class="fa-regular fa-pen-to-square"></i></a>
                                        <form action="{{ route('careerCategory.destroy', $data->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('careerCategory.store') }}" method="POST"  class="form-group">
                        @csrf
                        <input class="form-control" type="text" name="cat_name" placeholder="Department name"><br>
    ...
    <div class="modal fade" id="edit_cat_modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('careerCategory.update',1) }}" method="POST"  class="form-group">
                        @csrf
                        @method('PUT')
