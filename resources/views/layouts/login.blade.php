...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL::to('') }}/public/admin/assets/img/favicon.png">
        ...
        <div class="container">
            <div class="loginbox">
                <div class="login-left">
                    <img class="img-fluid" src="{{ URL::to('') }}/admin/assets/img/logo-png.png" alt="Logo">
                </div>
                <div class="login-right">
                    ...
                    @endif
                        ...
                        <div class="login-or">
                            <p style="text-align: center;color:white;">Contact for Log In Support</p>
                        </div>
