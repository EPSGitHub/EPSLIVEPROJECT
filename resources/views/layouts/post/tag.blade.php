 ...
 <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item active"><a style="color:rgb(100, 201, 231)" href="{{ route('home') }}">Dashboard</a> / <a style="color:rgb(100, 201, 231)" href="{{ route('post.index') }}">Blog post list</a> / Tags</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- </a> --}}
                                            <a href="#" edit_id="{{ $data->id }}" data-toggle="modal" class="btn btn-sm btn-warning update_tag" data-toggle="tooltip modal" title="Edit"><i class="fa-solid fa-pen-to-square"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('postTag.store') }}" method="POST"  class="form-group">
                        @csrf
                        <input class="form-control" type="text" name="tag_name_en" placeholder="Tag Name"><br>
                        <input class="form-control" type="text" name="tag_name_bn" placeholder="Bangla Tag Name"><br>
