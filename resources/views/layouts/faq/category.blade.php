       ...
       <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active"><a style="color:rgb(100, 201, 231)" href="{{ route('home') }}">Dashboard</a> / <a style="color:rgb(100, 201, 231)" href="{{ route('faqs.index') }}">FAQ List</a> / Categories</li>
                </ul>
            </div>
        </div>
    </div>
               ...
               <br><br>
                ...
                <div class="card col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <a href="#add_cat" class="btn btn-info d-inline" data-toggle="modal" style="float:right">Add Category</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('faqCategory.destroy', $data->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('faqCategory.store') }}" method="POST"  class="form-group">
                        @csrf
    ...
    <div class="modal fade" id="edit_cat_modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('faqCategory.update',1) }}" method="POST"  class="form-group">
                        @csrf
                        @method('PUT')
