  ...
  <div class="page-header">
    <div class="row">
        <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item active"><a style="color:rgb(100, 201, 231)" href="{{ route('home') }}">Dashboard</a> / <a style="color:rgb(100, 201, 231)" href="{{ route('faqs.index') }}">FAQ List</a> / Update</li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Update Q/A </h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="basictab1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="entitle" value="{{ $faq->ques_en }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select class="form-control post_tag_select"  name="entype">
                                                <option value="{{ $faq->faqCat->id }}">{{ $faq->faqCat->name_en }}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea rows="5" cols="5" name="endes"  class="form-control" id="ckeditor" placeholder="Enter text here">{{ $faq->des_en }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="basictab2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"  name="bntitle" value="{{ $faq->ques_bn }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea rows="5" cols="5" name="bndes"  class="form-control" id="ckeditorbn" placeholder="Enter text here">{{ $faq->des_bn }}</textarea>
                                        </div>
                                    </div>
