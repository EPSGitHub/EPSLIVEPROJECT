...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6 sin_img">
			...
			<div class="sing_text">
				<h4>@lang('about.shahalam')</h4>
				<span>@lang('about.MD')</span>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6 sin_des">
			<p class="full_des"> @lang('about.shahalam_paragraph_1') </p>
			<p class="full_des"> @lang('about.shahalam_paragraph_2')</p>
			<p class="full_des">  @lang('about.shahalam_paragraph_3')</p>
